...
const en: Record<string, string> = {
  ...
  "gap.title": "Gap since last report",
  "gap.message": "Your most recent report is {days} days ago. Carry over from it, or start from the template?",
  "gap.carry": "Carry over from it",
  "gap.template": "Start from template",
...
const zh: Record<string, string> = {
  ...
  "review.back": "返回修改",
  "gap.title": "距上次日报有间隔",
  "gap.message": "最近一份日报距今 {days} 天。要从它结转，还是从模板开始？",
  "gap.carry": "从它结转",
  "gap.template": "从模板开始",
  "status.pending": "进行中",
